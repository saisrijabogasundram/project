...
CREATE TABLE `discussions` (
  ...
  KEY `user_id` (`user_id`),
  KEY `course_id` (`course_id`),
  CONSTRAINT `discussions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),
  CONSTRAINT `discussions_ibfk_2` FOREIGN KEY (`course_id`) REFERENCES `courses` (`course_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `progress` (
  ...
  CONSTRAINT `progress_ibfk_2` FOREIGN KEY (`course_id`) REFERENCES `courses` (`course_id`),
  CONSTRAINT `progress_ibfk_3` FOREIGN KEY (`lesson_id`) REFERENCES `lessons` (`lesson_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'John Doe','john@example.com','password123','student','free','2023-10-01 04:30:00'),(3,'purvi','purvi@example.com','password123','student','free','2023-10-01 04:30:00'),(4,'Alice Smith','alice@example.com','password123','instructor','free','2023-10-01 04:30:00'),(9,'Smith','smith@example.com','password123','instructor','free','2025-09-15 17:11:40');
...
-- Dump completed on 2025-09-16 20:29:15
